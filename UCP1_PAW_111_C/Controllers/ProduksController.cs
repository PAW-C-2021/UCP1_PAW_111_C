...
namespace UCP1_PAW_111_C.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(TokoBukuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,NamaProduk,Jumlah,Harga")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,NamaProduk,Jumlah,Harga")] Produk produk)
        {
